...
class NewUserCarousel extends React.Component {
  ...
  componentDidMount() {
    const video = document.getElementsByClassName(
        `new-user-video-${this.state.slideIndex}`)[0];
    video.load();
    video.play();
    this.timer = setInterval( () =>
      this.nextSlide(this.state.slideIndex +1), 5000);
  }
  ...
  render() {
    const content = [
      <div className='New-User-Slide-0' key="New-User-Slide-0">
      ...
      <div className='New-User-Slide-1' key="New-User-Slide-1">
        <div className='New-User-Video-Container'>
      ...
      <div className='New-User-Slide-2' key="New-User-Slide-2">
        <div className='New-User-Video-Container'>
