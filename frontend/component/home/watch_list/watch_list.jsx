...
class WatchList extends React.Component {
  ...
  componentDidMount() {
    this.props.watchListInfo()
        .then( (res) =>
          this.props.watchListCurPrices(
              this.props.stockSymGetter(this.props.watchList)));
  }
  ...
  render() {
    const stockList = this.props.watchList.map( (stock, idx) => (
    ...
    const showList = stockList.length > 0 ? stockList : this.emptyList();
