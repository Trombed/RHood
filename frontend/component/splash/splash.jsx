...
import SplashCarousel from './carousel/carousel';
...
class Splash extends React.Component {
  ...
  render() {
    ...
    const content = (this.props.sessionId === null ) ? (
        ...
        <div className="splashContent-Container">
          <div className="splashContent-1-green">
            <div className="splashContent-1-green-left-container">
              <div className="splashContent-2-left-row-2">
                  It&lsquo;s Time to Do Money
              </div>
              <div className="splashContent-2-left-row-3">
                  Robinhood, a pioneer of commission-free investing,
                   gives you more ways to make your money work harder.
              </div>
              <div className='splashContent-2-left-row-4'>
                <Link to="/signup" >
                  <button className='splash-left-button'>
                    Sign Up
                  </button>
                </Link>
              </div>
          ...
          <div className="splashContent-2-white">
            ...
            <div className='splashContent-2-white-2'>
              Make unlimited commission-free trades in stocks, funds,
               and options with Robinhood Financial.
              The same goes for buying and selling cryptocurrencies with
              Robinhood Crypto. Zero commission fees.
            </div>
          </div>
          <SplashCarousel />
          <FictionalShares />
