...
class SplashCarousel extends React.Component {
  ...
  componentDidMount() {
    this.timer = setInterval( () =>
      this.nextSlide(this.state.slideIndex +1), 3000);
  };
  ...
  render() {
    const content = [<div className="Splash-Slide" id="Slide-1" key="Slide-1">
      ...
      <div className="Splash-Carousel-Slide-Text">
        ...
        <div className="Splash-Carousel-Slide-Text-Description">
          Our goal is to make investing in financial markets more affordable,
          more intuitive, and more fun, no matter how much experience you have
          (or don’t have).
        </div>
      </div>
    </div>,

    <div className="Splash-Slide" id="Slide-2" key="Slide-2">
      <div className="Splash-Carousel-Slide-Image">
      ...
      <div className="Splash-Carousel-Slide-Text">
        ...
        <div className="Splash-Carousel-Slide-Text-Description">
          Keep your portfolio in your pocket. Everything you need to manage your
          assets is available in a single app.
        </div>
      </div>
    </div>,

    <div className="Splash-Slide" id="Slide-3" key="Slide-3">
      <div className="Splash-Carousel-Slide-Image">
      ...
      <div className="Splash-Carousel-Slide-Text">
        ...
        <div className="Splash-Carousel-Slide-Text-Description">
          Set up customized news and notifications to stay on top of your assets
           as casually or as relentlessly as you like. Controlling the flow of
          info is up to you.
        </div>
      </div>
    </div>];
